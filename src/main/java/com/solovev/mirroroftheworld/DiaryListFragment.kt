...
class DiaryListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        diaryRecyclerView =
            view.findViewById(R.id.diary_recycler_view) as RecyclerView
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.new_diary -> {
                val crime = Crime()
                diaryListViewModel.addCrime(crime)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        diaryListViewModel.crimeListLiveData.observe(
            viewLifecycleOwner,
            Observer { crimes ->
                crimes?.let {
    ...
    private inner class CrimeAdapter(var crimes: List<Crime>)
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int)
                : CrimeHolder {
            val view = layoutInflater.inflate(R.layout.list_item_diary, parent, false)
